                    ...
                    dishes.map((item) => (
                        ...
                        >
                            ...
                            <div className="mb-3 border-b border-[#EEE7D2] pb-2">
                                ...
                                <h3 className="mt-0.5 break-words text-base font-bold text-[#3F5145] capitalize">
                                    {item.dishName}
                                </h3>
                            </div>
                            ...
                            <div className="mb-3">
                                ...
                                <Tooltip className={'message'} tooltipContent={item.description} >
                            ...
                            <div className="mb-3">
                                ...
                                <span className="mt-1 capitalize inline-block break-all rounded-full bg-[#F6D77A] px-2.5 py-0.5 text-xs font-medium text-[#3F5145]">
                                    {item.categoryName}
                                </span>
                            </div>
                            ...
                            <div className="mb-3">
                                ...
                                <div className="flex flex-wrap gap-1">
                                    {item.tagsname?.map((tag, index) => (
                                        <span
                                            key={index}
                                            className="rounded-full bg-[#3F5145] lowercase px-2 py-0.5 text-[10px] font-medium text-white"
                                        >
                                            {tag}
                                        </span>
                                    ))}
                                ...
                                <div className="flex flex-wrap gap-1">
                                    {item.ingredientsname?.map(
                                        (ingredient, index) => (
                                            <span
                                                key={index}
                                                className="rounded-full break-all lowercase border border-[#DDD8C7] bg-[#FFFDF5] px-2 py-0.5 text-[10px] text-[#697266]"
                                            >
                                                {ingredient}
                                            </span>
                                        )
